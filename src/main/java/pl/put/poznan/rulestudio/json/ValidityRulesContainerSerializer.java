...
public class ValidityRulesContainerSerializer extends JsonSerializer<ValidityRulesContainer> {
    ...
    public void serialize(ValidityRulesContainer validityRulesContainer, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        if(validityRulesContainer.getClassificationExternal() != null) {
            ...
            jsonGenerator.writeBooleanField("isCurrentProjectData", validityRulesContainer.getClassificationProjectData());
            jsonGenerator.writeObjectField("isCurrentRuleSet", validityRulesContainer.getClassificationRules());
            jsonGenerator.writeObjectField("isCurrentLearningData", validityRulesContainer.getClassificationLearningData());
            jsonGenerator.writeEndObject();
        } else {
            jsonGenerator.writeNull();
        }
