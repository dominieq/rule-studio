...
public class RulesWithHttpParametersSerializer extends JsonSerializer<RulesWithHttpParameters> {
    ...
    public void serialize(RulesWithHttpParameters rulesWithHttpParameters, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        if(rulesWithHttpParameters.getRulesFileName() != null) {
            jsonGenerator.writeFieldName("rulesFileName");
            jsonGenerator.writeString(rulesWithHttpParameters.getRulesFileName());
        }

        if(rulesWithHttpParameters.isCurrentData() != null) {
            jsonGenerator.writeBooleanField("isCurrentData", rulesWithHttpParameters.isCurrentData());
        }

        if(rulesWithHttpParameters.getValidityRulesContainer() != null) {
            jsonGenerator.writeFieldName("validityRulesContainer");
            jsonGenerator.writeRawValue(mapper.writeValueAsString(rulesWithHttpParameters.getValidityRulesContainer()));
        }
