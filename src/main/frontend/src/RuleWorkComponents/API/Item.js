 ...
 * @param {object} actions - Object containing possible actions that can be performed on Item.
 * @param {object} tables - Array of arrays that store further information.
 */
class Item {
