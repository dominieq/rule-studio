    ...
    return (
        <Chapter
            ...
            content={
                <React.Fragment>
                    <Typography>
                        If you wish to rename your current project, click on “Rename project” button. 
                        A dialog is going to be displayed with an input field to correct or write a new project name.
                    ...
                    <Image src={rename} caption={"Rename project dialog"} />
                </React.Fragment>
            }
        />
    );
