...
function CreatingProject(props) {
    ...
    return (
        <Chapter
            ...
            content={
                <React.Fragment>
                    <Image src={start} caption={"Empty “New project” page"} />
                    <Typography>
                        ...
                        New content will be displayed below this switch.
                    </Typography>
                    <Image src={middle} caption={"Creating new project with metadata"} />
                    <Typography>
                    ...
                    <Typography>
                        ...
                        an additional dialog will be displayed, where you can select a separator and choose 
                    ...
                    <Image src={csvDialog} caption={"CSV dialog"} />
                </React.Fragment>
            }
        />
    );
