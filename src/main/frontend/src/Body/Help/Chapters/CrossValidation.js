...
function CrossValidation(props) {
    ...
    return (
        <Chapter
            ...
            content={
                <React.Fragment>
                    <Image src={fullTab} caption={"Cross-validation"} />
                    <Typography>
                        ...
                        left. Five parameters from this drawer were described in the sections concerning decision rules and classification.
                        To customize seed, write an integer value in the text field or click on the button on the right to draw a random number.
                        To choose the number of cross-validation folds, write that number in the text field.
                    </Typography>
                    <Image src={settings} caption={"Parameters in “Cross-Validation”"} />
                    <Typography>
                        ...
                        Then, a new dialog is displayed.
                    </Typography>
                    <Image src={objectsDetails} caption={"Object’s details"} />
                    <Typography>
                    ...
                    <Image src={foldSelect} caption={"Selection of different fold"} />
                    <Typography>
                        It is possible to see mean and accumulated ordinal misclassification matrices, summarizing performed cross-validation.
                        There are two buttons in “All folds” section. The first one opens a dialog for the mean misclassification matrix,
                        and the second one for the accumulated misclassification matrix.
                    </Typography>
                    <Image src={sectionAllFolds} caption={"“All folds” section"} />
                    <Typography>
                    ...
                    <Image src={meanMatrix} caption={"Mean ordinal misclassification matrix"} />
                    <Typography>
                    ...
                    <Image src={sumMatrix} caption={"Accumulated ordinal misclassification matrix"} />
                    <Typography>
                        ...
                        cross-validation. Both matrices can be exported to a file. This process was already described above.
                        It is also possible to see ordinal misclassification matrix for a particular fold, using a button with identity matrix,
                        located in the “Fold” section. Click on it to open a new dialog.
                    </Typography>
                    <Image src={foldSection} caption={"“Fold” section"} />
                    <Image src={foldMatrix} caption={"Ordinal misclassification matrix for a single fold"} />
                    <Typography>
                        ...
                        Fold’s misclassification matrix can be exported to a file as well. To this end, follow the instructions presented above.
                    </Typography>
                </React.Fragment>
            }
        />
