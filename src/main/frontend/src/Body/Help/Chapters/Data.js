    ...
    return (
        <React.Fragment>
            <Chapter
                ...
                content={
                    <React.Fragment>
                        <Image src={fullTab} caption={"Data"} />
                        <Typography component={'span'}>
                            ...
                            In above figure you can see from the top:
                            <ol>
                                <li> App bar </li>
                        ...
                        <Image src={buttons} caption={"Data buttons"} />
                        <Typography component={'span'}>
                            From left to right:
                            <ol type="a">
                                ...
                                <li> Add attribute – opens the “add attribute” dialog. </li>
                                <li> Edit attributes – opens the “edit attributes” dialog. </li>
                                <li> Save to file – opens the “save to file” dialog. </li>
                                <li> Transform – opens the “impose preference orders” dialog. </li>
                        ...
                        <Image src={columnsHeaders} caption={"Columns headers with filters"} />
                        <Typography>
                            The abouve figure presents columns headers. Each header has meaningful color, which informs about the nature 
                            ...
                            Right click on the header opens header context menu.
                        </Typography>
                        <Image src={headerContextMenu} caption={"Header context menu"} />
                        <Typography>
                        ...
                        <Typography> 
                            ...
                            cell and enter the copy-paste mode, which is indicated by dark blue background color of the cell.
                        ...
                        <Image src={copyPaste} caption={"Copy-paste mode"} />
                        <Typography>
                            ...
                            click on a square located in the bottom right corner of the cell and start dragging it upwards or downwards.
                        ...
                        <Image src={dragCell} caption={"Dragging downwards"} />
                        <Typography>
                            Similarly to the header context menu, there is a row context menu. To open the menu, right click on the cell.
                            The menu enables to remove the object presented in cell’s row, and add new object above or below current object.
                        </Typography>
                        <Image src={rowContextMenu} caption={"Row context menu"} />
                        <Typography component={"header"} paragraph={true} variant={"h6"}>
                            Add attribute
                        </Typography>
                        <Image src={addAttribute} caption={"Add attribute dialog"} />
                        <Typography>
                            To create a new attribute, you have to fill all the mandatory fields (marked by asterisk) in the “Add attribute” dialog.
                            If the selected value type is “enumeration”, then additional button will appear to add domain elements, 
                            like in the “Edit attributes” dialog. After filling the fields, click “APPLY” to save changes and close the dialog.
                        ...
                        <Image src={editAttributes} caption={"Edit attributes dialog"} />
                        <Typography>
                            In order to edit an attribute, you have to select it from the “ATTRIBUTES” list. After selecting the attribute,
                            all the attribute fields will appear, and you can make desirable changes. After that, you have to click “APPLY” button
                        ...
                        <Image src={saveToFile} caption={"Save to file dialog"} />
                        <Typography>
                        ...
                        <Image src={transform} caption={"Impose preference orders dialog"} />
                        <Typography>
                            This dialog enables to perform non-invasive transformation of the data. 
