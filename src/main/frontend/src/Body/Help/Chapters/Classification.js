...
function Classification(props) {
    ...
    return (
        <Chapter
            ...
            content={
                <React.Fragment>
                    <Image src={fullTab} caption={"FIGURE 35: Classification"} />
                    <Typography>
                        ...
                        into the tab from the left (Fig. 36). To customize type of classifier and default classification result,
                    ...
                    <Image src={settings} caption={"FIGURE 36: Parameters in “CLASSIFICATION”"} />
                    <Typography>
                        ...
                        click on its left part with filled arrow. A menu is going to appear below the split button (Fig. 37).
                    ...
                    <Image src={classifyButton} caption={"FIGURE 37: Split button in “CLASSIFICATION”"} />
                    <Typography>
                        It is possible to see the details of an object. In order to do that, you have to click on one of the objects from
                        the result list. A new dialog is going to be displayed (Fig. 38).
                    </Typography>
                    <Image src={objectsDetails} caption={"FIGURE 38: Classified object’s details"} />
                    <Typography>
                        ...
                        There is an option to see more detailed description of a selected covering rule.
                        In order to do that, double click on the upper right list. New content is going to slide into the dialog from the right.
                        Composition of this content was presented in “Rules”.
                    </Typography>
                    <Typography>
                        It is also possible to see the ordinal misclassification matrix for the performed classification.
                        To this end, while being in the main view of the “CLASSIFICATION” tab,
                        you have to click on a button with identity matrix icon.
                        Then, a new dialog is going to be displayed (Fig. 39).
                    </Typography>
                    <Image src={matrix} caption={"FIGURE 39: Ordinal misclassifcation matrix in “CLASSIFICATION”"} />
                    <Typography>
